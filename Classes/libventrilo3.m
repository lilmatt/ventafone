 ...
 *
 * $LastChangedDate: 2010-06-07 19:09:28 -0700 (Mon, 07 Jun 2010) $
 * $Revision: 890 $
 * $LastChangedBy: clearscreen $
 * $URL: http://svn.mangler.org/mangler/tags/1.2.0/libventrilo3/libventrilo3.c $
 *
...
#import "ventrilo3.h"
#import "libventrilo3.h"
#import "libventrilo3_message.h"
...
_v3_audio_encode(
    ...
    switch (codec->codec) {
      ...
      case 0x03: // SPEEX
      {
        ...
        if (!spxenc || codec->rate != rate || codec->format != format || [(VentafoneAppDelegate *)[[UIApplication sharedApplication] delegate] refreshEncoder]) {
            [(VentafoneAppDelegate *)[[UIApplication sharedApplication] delegate] setRefreshEncoder:NO];
			if (spxenc) {
            ...
            rate = codec->rate;
            format = codec->format;
			if ([[(VentafoneAppDelegate *)[[UIApplication sharedApplication] delegate] globalSettings] recordOverride])
			{
